...
osg::StateSet *MaterialGenerator::generate()
{
    ...
    return create(false, false, nullptr, 0);
}
...
osg::StateSet *MaterialGenerator::generateForCompositeMapRTT(int lodLevel)
{
    ...
    return create(true, false, nullptr, lodLevel);
}

osg::StateSet *MaterialGenerator::generateForCompositeMap(osg::Texture2D *compositeMap)
{
    return create(false, true, compositeMap, 0);
}

osg::StateSet *MaterialGenerator::create(bool renderCompositeMap, bool displayCompositeMap,
                                         osg::Texture2D *compositeMap, int lodLevel)
{
    ...
    else
    {
        ...
        const double scale = 16. * double(1<<lodLevel);
